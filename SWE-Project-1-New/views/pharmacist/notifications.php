...
<main class="main-content">
        ...
        <div class="notification-item <?php echo $notification['read'] ? 'read' : 'unread'; ?> priority-<?php echo $notification['priority']; ?>" 
            ...
            <div class="notification-content">
                ...
                <div class="notification-actions">
                    <a href="<?php echo getBaseUrl(); ?>routes/pharmacist_inventory.php" class="btn btn-sm btn-primary">
    ...
    <div class="quick-actions-section">
        ...
        <div class="quick-actions">
            <a href="<?php echo getBaseUrl(); ?>routes/pharmacist_inventory.php?status=low_stock" class="action-card">
                <i class="fas fa-exclamation-triangle"></i>
                <h3>View Low Stock Items</h3>
                <p>Check all items with low inventory</p>
            </a>
            
            <a href="<?php echo getBaseUrl(); ?>routes/pharmacist_inventory.php?status=expiring_soon" class="action-card">
                <i class="fas fa-clock"></i>
