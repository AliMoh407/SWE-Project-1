...
<main class="main-content">
    <div class="page-header">
        ...
        <div class="page-actions">
            <a href="<?php echo getBaseUrl(); ?>routes/doctor_requests.php" class="btn btn-primary">
    ...
    <div class="filters-container">
        <form method="GET" class="filters-form">
            ...
            <a href="<?php echo getBaseUrl(); ?>routes/doctor_request_history.php" class="btn btn-outline">
