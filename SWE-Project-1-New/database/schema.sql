...
-- Insert sample users (password is 'password' hashed with password_hash)
-- Default password for all sample users: 'password'
INSERT INTO `users` (`username`, `password`, `role`, `name`, `email`) VALUES
('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 'Admin User', 'admin@meditrack.com'),
('doctor1', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'doctor', 'Dr. Sarah Johnson', 'doctor1@meditrack.com'),
('pharmacist1', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'pharmacist', 'Pharmacist User', 'pharmacist1@meditrack.com')
...
-- Insert sample activity logs (using user_id from sample users above)
INSERT IGNORE INTO `activity_logs` (`user_id`, `action`, `status`, `timestamp`) VALUES
...
INSERT IGNORE INTO `notifications` (`type`, `title`, `message`, `item_id`, `priority`, `read`, `timestamp`) VALUES
