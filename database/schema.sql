...
-- Insert sample users (must be inserted before activity_logs due to foreign key constraint)
-- Note: Passwords should be hashed in production. These are example hashes.
INSERT INTO `users` (`username`, `password`, `role`, `name`, `email`) VALUES
('admin', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 'Admin User', 'admin@meditrack.com'),
('pharmacist1', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'pharmacist', 'Pharmacist One', 'pharmacist1@meditrack.com'),
('doctor1', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'doctor', 'Dr. Sarah Johnson', 'doctor1@meditrack.com');

-- Insert sample activity logs (now user_id 1 and 2 exist)
