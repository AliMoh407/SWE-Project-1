    ...
    <div class="dashboard-content">
        ...
        <div class="dashboard-section">
            ...
            <div class="quick-actions">
                <a href="<?php echo getBaseUrl(); ?>routes/admin_users.php" class="action-card">
                    <i class="fas fa-user-plus"></i>
                    <h3>Manage Users</h3>
                    <p>Create, edit, or delete user accounts</p>
                </a>
                <a href="<?php echo getBaseUrl(); ?>routes/admin_reports.php" class="action-card">
                    <i class="fas fa-chart-bar"></i>
                    <h3>View Reports</h3>
                    <p>System reports and analytics</p>
                </a>
                <a href="<?php echo getBaseUrl(); ?>routes/admin_activity_logs.php" class="action-card">
                    <i class="fas fa-history"></i>
                    <h3>Activity Logs</h3>
        ...
        <div class="dashboard-section">
            <h2>Quick Actions</h2>
            <div class="quick-actions">
                <a href="<?php echo getBaseUrl(); ?>routes/doctor_requests.php" class="action-card">
                    <i class="fas fa-plus-circle"></i>
                    <h3>Request Items</h3>
                    <p>Request medicines or equipment</p>
                </a>
                <a href="<?php echo getBaseUrl(); ?>routes/doctor_request_history.php" class="action-card">
